  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="max-w-lg w-full min-w-[300px] rounded-xl shadow-lg bg-white p-6">
        <h1 className="text-2xl font-bold text-green-700 mb-4 text-center">User Profile</h1>
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-green-600">Favorite Recipes</label>
